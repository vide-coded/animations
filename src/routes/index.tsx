    ...
    <div className="container mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
      ...
      <div className="mb-6 sm:mb-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="w-full sm:w-auto">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-2 bg-gradient-to-r from-foreground to-foreground/60 bg-clip-text text-transparent">
            Brain-Rot
          </h1>
        ...
        {/* Actions: Favorites & Theme Toggle */}
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <Link
            to="/favorites"
            className={cn(
              'inline-flex items-center gap-2 px-4 py-2.5 rounded-lg flex-1 sm:flex-initial justify-center',
